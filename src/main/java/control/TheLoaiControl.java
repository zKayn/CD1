...
@WebServlet(name="TheLoaiControl", urlPatterns={"/TheLoai"})
public class TheLoaiControl extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        List<TopPhimMoi> listPBYTL = dao.getPhimByIDTheLoai(idTL);
        ...
        request.setAttribute("listPhim", listPBYTL);
